...
function cbg_core_page_library() {
	...
	return array(
		...
		'results' => cbg_core_page( 'Results & Case Studies', 'Real businesses. Real marketing infrastructure. Reported annual revenue.', 'Contractor Marketing Case Studies | Contractor Build', 'See client businesses Contractor Build has supported across websites, Local Services Ads, Google Ads, Google Business Profile, and paid social.', '<h2>$4.35M+ in combined annual client revenue</h2><p>These businesses report more than $4.35 million in combined annual revenue. Contractor Build work for the businesses shown included website development, Local Services Ads account setup or management, Google Ads campaign setup, Google Business Profile work, and paid social media advertising.</p><ul><li>Mi Lock Pros LLC — $500K+ reported annual business revenue</li><li>TX Lock &amp; Key LLC — $600K+</li><li>INDY LOCK &amp; KEYS LLC — $400K+</li><li>Express Local Towing — $1M+</li><li>Kingdom of Keys — $600K+</li><li>AJ Detailing — $300K+</li><li>Legacy Roadside Assistance — $200K+</li><li>Saline Detailing — $250K+</li><li>MLK Locksmith — $500K+</li></ul><h2>Work performed</h2><p>Across these engagements, Contractor Build worked on websites, eligible Local Services Ads accounts, Google Ads campaigns, Google Business Profiles, and paid social media advertising.</p><p><strong>Results context:</strong> Annual revenue figures are client/business figures provided to Contractor Build and are not presented as revenue solely attributable to Contractor Build or any individual advertising channel. Past results do not guarantee future results. Individual performance varies by business, market, budget, operations, competition, and execution.</p>[contractor_build_case_studies]<p><a href="/free-marketing-audit/">Discuss the growth system for your business</a>.</p>' ),
	);
}

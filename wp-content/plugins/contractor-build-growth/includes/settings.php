...
function cbg_settings_page() {
	...
	<tr><th><label for="cbg_lead_email">Lead notification email</label></th><td><input class="regular-text" id="cbg_lead_email" name="cbg_lead_email" type="email" value="<?php echo esc_attr( get_option( 'cbg_lead_email', 'cotractorbuild0@gmail.com' ) ); ?>"></td></tr>
	...
	<tr><th><label for="cbg_email">Public business email</label></th><td><input class="regular-text" type="email" id="cbg_email" name="cbg_email" value="<?php echo esc_attr( get_option( 'cbg_email', 'cotractorbuild0@gmail.com' ) ); ?>"></td></tr>
